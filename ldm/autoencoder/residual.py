...
class ResidualUnit(nn.Module):
    def __init__(self, n_channels: int, kernel_size: int, multiplier: int):
        """
        ...
        Arguments:
            ...
            - multiplier: int - the size of the hidden layer, with respect to `n_channels`
        """
...
class Residual(nn.Module):
    def __init__(
        self, n_layers: int, n_channels: int, kernel_size: int, multiplier: int = 2
    ):
        """
        ...
        Arguments:
            ...
            - kernel_size: int - the size of the kernel to use
            - multiplier: int - the multiplier to use for each residual layer; defaults to `2`
        """
